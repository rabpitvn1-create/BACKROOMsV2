...
**BR 1.0.0.0.5** (`versionCode 103`). Rương xuất hiện với tỉ lệ 5%; vật phẩm từ Entity và Core trong rương đều có tỉ lệ rơi 100%. Loot pool và số lượng phần thưởng giữ nguyên.

APK debug và ghi chú phiên bản được phát hành tại [GitHub Releases](https://github.com/rabpitvn1-create/BACKROOMsV2/releases). Xem [ghi chú BR 1.0.0.0.5](android-apk/RELEASE_NOTES_BR_1.0.0.0.5.txt) để biết các thay đổi.
