...
final class ItemCore {
  static final int CHEST_SPAWN_RATE_PERCENT = 5;
  static final int ENTITY_DROP_MIN_PERCENT = 100;
  static final int ENTITY_DROP_MAX_PERCENT = 100;
  static final int CORE_CHEST_DROP_PERCENT = 100;
